...
use VK\Exceptions\Api\VKApiAppAuthException;
...
class VKApiRequest {
    ...
    public function post(string $method, string $access_token, array $params = array()) {
        ...
        /** @var VKAntiFloodRepository $antiFloodRepo */
        $antiFloodRepo = app()[VKAntiFloodRepository::class];
        $antiFloodRepo->waitForQueue($access_token,$method);
        ...
        try {
            ...
            return $this->post($method,$access_token,$params);
        } catch (VKApiAppAuthException $e) {
